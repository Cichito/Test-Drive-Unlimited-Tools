...
- Turbo really unsafe but it will get the gob done in less than 1 hour

## Logs
Both scripts generate detailed log files that can be useful for identifying any errors.
